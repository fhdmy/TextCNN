...
def build_model(vocab, config, train=True):
...
def train_model(model, train_data, valid_data, padding_idx, config,epochs):
    # Build optimizer.
...
def main(epochs,batch_size,config=None):
    # parse config
    if config==None:
        config = parse_config()
    # load train data
    ...
    train_model(model, train_data,
                        valid_data, padding_idx,config,epochs)
